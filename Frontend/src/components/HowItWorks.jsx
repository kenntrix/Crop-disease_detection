...
const HowItWorks = () => {
  const steps = [
    ...
    {
      icon: <MdSecurity className="text-green-600 w-8 h-8" />,
      text: "Your data is processed securely, ensuring privacy and safety.",
    },
    {
      icon: <GiProgression className="text-green-600 w-8 h-8" />,
      text: "Our AI continuously learns from new data to improve accuracy.",
    },
  ];
